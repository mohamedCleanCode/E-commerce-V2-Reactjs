...
const Header = () => {
  return (
    <Navbar bg="white" expand="lg" className="header mb-2">
      <Container>
        ...
        >
          <Nav className="ms-auto">
            <Nav.Link href="#home" className="d-flex flex-column text-center">
              <span>
                <FontAwesomeIcon icon={faUser} />
              </span>
              <span>Profile</span>
            </Nav.Link>
            <Nav.Link href="#link" className="d-flex flex-column text-center">
              <span>
